...
新冠肺炎疫情一直是商业运作方式快速变化的催化剂。技术发展的速度太快，以至于必要的安全措施都跟不上。它的复杂性激增，保持复杂系统足够安全是一个挑战。此外，在线可用数据的巨大增长增加了其流通性及其对企业和黑客的价值，导致更成功、更有利可图的数据窃取攻击。
